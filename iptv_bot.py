...
TKGS_ONCELIKLI_KANALLAR = [
    ...
    {"regex": r"\bbeIN\s*Sports?\s*1\b|\bbeIN\s*1\b", "ad": "beIN SPORTS 1 HD (Canlı Maç)", "epg_id": "beINSPORTS1.tr", "kategori": "3. TKGS - Spor & Canlı Maç / UFC", "chno": 40, "logo": "https://upload.wikimedia.org/wikipedia/commons/thumb/9/93/BeIN_Sports_logo.svg/800px-BeIN_Sports_logo.svg.png", "default_url": "http://463758a0.ucomist.net/iptv/V4ZVP6G52HVXDE/6817/index.m3u8"},
    {"regex": r"\bbeIN\s*Sports?\s*2\b|\bbeIN\s*2\b", "ad": "beIN SPORTS 2 HD (Canlı Maç)", "epg_id": "beINSPORTS2.tr", "kategori": "3. TKGS - Spor & Canlı Maç / UFC", "chno": 41, "logo": "https://upload.wikimedia.org/wikipedia/commons/thumb/9/93/BeIN_Sports_logo.svg/800px-BeIN_Sports_logo.svg.png", "default_url": "http://463758a0.ucomist.net/iptv/V4ZVP6G52HVXDE/6819/index.m3u8"},
    {"regex": r"\bbeIN\s*Sports?\s*3\b|\bbeIN\s*3\b", "ad": "beIN SPORTS 3 HD (Canlı Maç)", "epg_id": "beINSPORTS3.tr", "kategori": "3. TKGS - Spor & Canlı Maç / UFC", "chno": 42, "logo": "https://upload.wikimedia.org/wikipedia/commons/thumb/9/93/BeIN_Sports_logo.svg/800px-BeIN_Sports_logo.svg.png", "default_url": "https://1.nejyoner19.workers.dev/?url=https://corestream.ronaldovurdu.help//hls/bein-sports-3.m3u8"},
    {"regex": r"\bbeIN\s*Sports?\s*4\b|\bbeIN\s*4\b", "ad": "beIN SPORTS 4 HD (Canlı Maç)", "epg_id": "beINSPORTS4.tr", "kategori": "3. TKGS - Spor & Canlı Maç / UFC", "chno": 43, "logo": "https://upload.wikimedia.org/wikipedia/commons/thumb/9/93/BeIN_Sports_logo.svg/800px-BeIN_Sports_logo.svg.png", "default_url": "https://1.nejyoner19.workers.dev/?url=https://corestream.ronaldovurdu.help//hls/bein-sports-4.m3u8"},
    {"regex": r"\bS\s*Sport\s*1\b|\bSSPORT1?\b(?!.*(?:2|Plus))", "ad": "S SPORT 1 HD (Premier Lig & La Liga)", "epg_id": "SSPORT.tr", "kategori": "3. TKGS - Spor & Canlı Maç / UFC", "chno": 44, "logo": "https://i.imgur.com/7w8hLKg.png", "default_url": "https://1.nejyoner19.workers.dev/?url=https://corestream.ronaldovurdu.help//hls/s-sport.m3u8"},
    {"regex": r"\bS\s*Sport\s*2\b|\bSSPORT2\b", "ad": "S SPORT 2 HD (EuroLeague & Serie A)", "epg_id": "SSPORT2.tr", "kategori": "3. TKGS - Spor & Canlı Maç / UFC", "chno": 45, "logo": "https://i.imgur.com/7w8hLKg.png", "default_url": "https://1.nejyoner19.workers.dev/?url=https://corestream.ronaldovurdu.help//hls/s-sport-2.m3u8"},
    {"regex": r"\bS\s*Sport\s*plus\s*1\b|\bSSPORT\s*PLUS\s*1\b", "ad": "S SPORT PLUS 1 HD", "epg_id": "SSPORTPLUS1.tr", "kategori": "3. TKGS - Spor & Canlı Maç / UFC", "chno": 46, "logo": "https://i.imgur.com/7w8hLKg.png", "default_url": "https://1.nejyoner19.workers.dev/?url=https://one.c37c5ccda41b4ac6.click/live/sssplus1/playlist.m3u8?_HLS_skip=YES"},
    {"regex": r"\bS\s*Sport\s*plus\s*2\b|\bSSPORT\s*PLUS\s*2\b", "ad": "S SPORT PLUS 2 HD", "epg_id": "SSPORTPLUS2.tr", "kategori": "3. TKGS - Spor & Canlı Maç / UFC", "chno": 47, "logo": "https://i.imgur.com/7w8hLKg.png", "default_url": "https://1.nejyoner19.workers.dev/?url=https://one.c37c5ccda41b4ac6.click/live/sssplus2/playlist.m3u8?_HLS_skip=YES"},
    {"regex": r"\bTivibu\s*Spor\s*1\b|\bTivibu\s*1\b", "ad": "TİVİBU SPOR 1 HD", "epg_id": "TivibuSpor.tr", "kategori": "3. TKGS - Spor & Canlı Maç / UFC", "chno": 48, "logo": "https://upload.wikimedia.org/wikipedia/commons/thumb/a/a6/Tivibu_Spor_logo.png/800px-Tivibu_Spor_logo.png", "default_url": "https://1.nejyoner19.workers.dev/?url=https://corestream.ronaldovurdu.help//hls/tivibu-spor-1.m3u8"},
    {"regex": r"\bTivibu\s*Spor\s*2\b|\bTivibu\s*2\b", "ad": "TİVİBU SPOR 2 HD", "epg_id": "TivibuSpor.tr", "kategori": "3. TKGS - Spor & Canlı Maç / UFC", "chno": 49, "logo": "https://upload.wikimedia.org/wikipedia/commons/thumb/a/a6/Tivibu_Spor_logo.png/800px-Tivibu_Spor_logo.png", "default_url": "https://1.nejyoner19.workers.dev/?url=https://corestream.ronaldovurdu.help//hls/tivibu-spor-2.m3u8"},
    {"regex": r"\bTivibu\s*Spor\s*3\b|\bTivibu\s*3\b", "ad": "TİVİBU SPOR 3 HD", "epg_id": "TivibuSpor.tr", "kategori": "3. TKGS - Spor & Canlı Maç / UFC", "chno": 50, "logo": "https://upload.wikimedia.org/wikipedia/commons/thumb/a/a6/Tivibu_Spor_logo.png/800px-Tivibu_Spor_logo.png", "default_url": "https://1.nejyoner19.workers.dev/?url=https://corestream.ronaldovurdu.help//hls/tivibu-spor-3.m3u8"},
    {"regex": r"\bTabii\s*TV\b|\bTabii\b(?!.*(?:Spor))", "ad": "TABİİ TV HD (TRT Tabii)", "epg_id": "TabiiTV.tr", "kategori": "3. TKGS - Spor & Canlı Maç / UFC", "chno": 51, "logo": "https://ceokzokgtd.erbvr.com/tabiitv/tabiitv.png", "default_url": "https://ceokzokgtd.erbvr.com/tabiitv/tabiitv.m3u8"},
    {"regex": r"\bTabii\s*Spor\s*5\b", "ad": "TABİİ SPOR 5 HD", "epg_id": "TabiiSpor5.tr", "kategori": "3. TKGS - Spor & Canlı Maç / UFC", "chno": 52, "logo": "https://ceokzokgtd.erbvr.com/tabiitv/tabiitv.png", "default_url": "https://z3mmimwz148csv0vaxtphqspf.medya.trt.com.tr/master.m3u8"},
    {"regex": r"\bTabii\s*Spor\s*6\b", "ad": "TABİİ SPOR 6 HD", "epg_id": "TabiiSpor6.tr", "kategori": "3. TKGS - Spor & Canlı Maç / UFC", "chno": 53, "logo": "https://ceokzokgtd.erbvr.com/tabiitv/tabiitv.png", "default_url": "https://vbtob9hyq58eiophct5qctxr2.medya.trt.com.tr/master.m3u8"},
    {"regex": r"\bTabii\s*Spor\s*7\b", "ad": "TABİİ SPOR 7 HD", "epg_id": "TabiiSpor7.tr", "kategori": "3. TKGS - Spor & Canlı Maç / UFC", "chno": 54, "logo": "https://ceokzokgtd.erbvr.com/tabiitv/tabiitv.png", "default_url": "https://rxnE77JupTdEYKE3TytvGQWYh.medya.trt.com.tr/master.m3u8"},
    {"regex": r"\bDAZN\s*1\b", "ad": "DAZN 1 HD", "epg_id": "DAZN1.de", "kategori": "3. TKGS - Spor & Canlı Maç / UFC", "chno": 55, "logo": "https://upload.wikimedia.org/wikipedia/commons/thumb/a/a2/DAZN_Logo.svg/800px-DAZN_Logo.svg.png", "default_url": "https://1.nejyoner19.workers.dev/?url=https://one.c37c5ccda41b4ac6.click/live/sdazn1/playlist.m3u8?_HLS_skip=YES"},
    {"regex": r"\bDAZN\s*2\b", "ad": "DAZN 2 HD", "epg_id": "DAZN2.de", "kategori": "3. TKGS - Spor & Canlı Maç / UFC", "chno": 56, "logo": "https://upload.wikimedia.org/wikipedia/commons/thumb/a/a2/DAZN_Logo.svg/800px-DAZN_Logo.svg.png", "default_url": "https://1.nejyoner19.workers.dev/?url=https://one.c37c5ccda41b4ac6.click/live/sdazn2/playlist.m3u8?_HLS_skip=YES"},
    {"regex": r"\bEuro\s*Sport\s*1\b|\bEurosport\s*1\b", "ad": "EUROSPORT 1 HD", "epg_id": "Eurosport1.tr", "kategori": "3. TKGS - Spor & Canlı Maç / UFC", "chno": 57, "logo": "https://upload.wikimedia.org/wikipedia/commons/thumb/d/d4/Eurosport_1_logo.svg/800px-Eurosport_1_logo.svg.png", "default_url": "https://1.nejyoner19.workers.dev/?url=https://one.c37c5ccda41b4ac6.click/live/seurosport1/playlist.m3u8?_HLS_skip=YES"},
    {"regex": r"\bEuro\s*Sport\s*2\b|\bEurosport\s*2\b", "ad": "EUROSPORT 2 HD", "epg_id": "Eurosport2.tr", "kategori": "3. TKGS - Spor & Canlı Maç / UFC", "chno": 58, "logo": "https://upload.wikimedia.org/wikipedia/commons/thumb/9/91/Eurosport_2_logo.svg/800px-Eurosport_2_logo.svg.png", "default_url": "https://1.nejyoner19.workers.dev/?url=https://one.c37c5ccda41b4ac6.click/live/seurosport2/playlist.m3u8?_HLS_skip=YES"},
    {"regex": r"\bTRT\s*Spor\b(?!.*Y[ıi]ld[ıi]z)", "ad": "TRT SPOR HD (Şampiyonlar Ligi)", "epg_id": "TRT.SPOR.HD.tr", "kategori": "3. TKGS - Spor & Canlı Maç / UFC", "chno": 59, "logo": "https://upload.wikimedia.org/wikipedia/commons/thumb/c/c9/TRT_Spor_logo_%282021-%29.svg/800px-TRT_Spor_logo_%282021-%29.svg.png", "default_url": "https://tv-trtspor1.medya.trt.com.tr/master.m3u8"},
    {"regex": r"\bTRT\s*Spor\s*Y[ıi]ld[ıi]z\b", "ad": "TRT SPOR YILDIZ HD", "epg_id": "TRT.SPOR.HD.tr", "kategori": "3. TKGS - Spor & Canlı Maç / UFC", "chno": 60, "logo": "https://upload.wikimedia.org/wikipedia/commons/thumb/c/ce/TRT_Spor_Y%C4%B1ld%C4%B1z_Logo.svg/800px-TRT_Spor_Y%C4%B1ld%C4%B1z_Logo.svg.png", "default_url": "https://tv-trtspor2.medya.trt.com.tr/master.m3u8"},
    {"regex": r"\bA\s*Spor\b", "ad": "A SPOR HD", "epg_id": "A.SPOR.tr", "kategori": "3. TKGS - Spor & Canlı Maç / UFC", "chno": 61, "logo": "https://i.imgur.com/ZhkZzLf.png", "default_url": "https://rnttwmjcin.turknet.ercdn.net/lcpmvefbyo/aspor/aspor.m3u8"},
    {"regex": r"\bTV\s*8\.5\b|\bTV\s*8,5\b", "ad": "TV8.5 HD (Şampiyonlar Ligi Maçları)", "epg_id": "TV8.HD.tr", "kategori": "3. TKGS - Spor & Canlı Maç / UFC", "chno": 62, "logo": "https://upload.wikimedia.org/wikipedia/commons/thumb/f/f6/TV8_5_Logo.png/800px-TV8_5_Logo.png", "default_url": "https://rkhubpaomb.turknet.ercdn.net/fwjkgpasof/tv8bucuk/tv8bucuk.m3u8"},
    {"regex": r"\bHT\s*Spor\b", "ad": "HT SPOR HD", "epg_id": "HTSPOR.tr", "kategori": "3. TKGS - Spor & Canlı Maç / UFC", "chno": 63, "logo": "https://i.imgur.com/ZhkZzLf.png", "default_url": "https://rmtftbjlne.turknet.ercdn.net/bpeytmnqyp/ht-spor/ht-spor.m3u8"},
    {"regex": r"\bEkol\s*Sports?\b", "ad": "EKOL SPORTS HD", "epg_id": "EkolSport.tr", "kategori": "3. TKGS - Spor & Canlı Maç / UFC", "chno": 64, "logo": "https://i.imgur.com/ZhkZzLf.png", "default_url": "https://ekoltv-live.ercdn.net/ekolsport/ekolsport_1080p.m3u8?autoplay=1"},
    {"regex": r"\bTJK\s*TV\b", "ad": "TJK TV HD (Canlı Yarış)", "epg_id": "TJK.tr", "kategori": "3. TKGS - Spor & Canlı Maç / UFC", "chno": 65, "logo": "https://upload.wikimedia.org/wikipedia/commons/thumb/b/b3/TJK_TV_logo.png/800px-TJK_TV_logo.png", "default_url": "https://tjktv-live.tjk.org/tjktv/tjktv.m3u8"},
    {"regex": r"\bCBC\s*Sport\b", "ad": "CBC SPORT HD (Şampiyonlar Ligi & Premier Lig)", "epg_id": "CBCSport.az", "kategori": "3. TKGS - Spor & Canlı Maç / UFC", "chno": 66, "logo": "https://upload.wikimedia.org/wikipedia/commons/thumb/6/6f/CBC_Sport_logo.png/800px-CBC_Sport_logo.png"},
    {"regex": r"\b[Iİi]dman\b|\bIdman\s*TV\b", "ad": "İDMAN TV HD (Şampiyonlar Ligi & UFC)", "epg_id": "IdmanTV.az", "kategori": "3. TKGS - Spor & Canlı Maç / UFC", "chno": 67, "logo": "https://upload.wikimedia.org/wikipedia/commons/thumb/8/87/Idman_TV_logo.png/800px-Idman_TV_logo.png"},
    {"regex": r"\bFB\s*TV\b|\bFenerbah[cç]e\s*TV\b", "ad": "FB TV HD", "epg_id": "FENERBAHÇE.TV.tr", "kategori": "3. TKGS - Spor & Canlı Maç / UFC", "chno": 68, "logo": "https://upload.wikimedia.org/wikipedia/commons/thumb/6/6f/Fenerbah%C3%A7e_TV_logo.png/800px-Fenerbah%C3%A7e_TV_logo.png", "default_url": "http://1hskrdto.rocketcdn.com/fenerbahcetv.smil/playlist.m3u8"},
    {"regex": r"\bORF\s*1\b|\bORF\s*Sport\b", "ad": "ORF SPORT HD (Avusturya)", "epg_id": "ORFSportPlus.at", "kategori": "3. TKGS - Spor & Canlı Maç / UFC", "chno": 69, "logo": "https://upload.wikimedia.org/wikipedia/commons/thumb/a/a2/ORF_1_logo.svg/800px-ORF_1_logo.svg.png", "default_url": "https://7nyaler.streamhostingcdn.top/stream/50/index.m3u8"},
    {"regex": r"\bUFC\b|\bUFC\s*HD\b", "ad": "UFC HD (Canlı Dövüş & Boks)", "epg_id": "", "kategori": "3. TKGS - Spor & Canlı Maç / UFC", "chno": 70, "logo": "https://upload.wikimedia.org/wikipedia/commons/thumb/0/0d/UFC_logo.svg/800px-UFC_logo.svg.png", "default_url": "http://463758a0.ucomist.net/iptv/V4ZVP6G52HVXDE/2000/index.m3u8"},
...
def kanallari_tara_sirala_ve_filtrele(config):
    ...
    for k in kaynaklar:
        ...
        url = k.get("url")
        try:
            print(f"  -> İndiriliyor / Okunuyor: {ad}")
            if os.path.exists(url):
                with open(url, "r", encoding="utf-8", errors="ignore") as f:
                    content = f.read()
                parsed = parse_m3u(content)
                print(f"     Bulunan yerel içerik sayısı: {len(parsed)}")
